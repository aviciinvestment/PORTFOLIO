      ...
      <div id="home" className="max-w-7xl mx-auto px-6 md:px-12 py-8 relative z-10 flex flex-col min-h-screen">
        ...
        >
          ...
          <div className="flex items-center gap-3 shrink-0">
            {site?.resumeUrl ? (
              <a href={site.resumeUrl} download="resume.pdf" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 transition-colors rounded-full px-4 lg:px-6 py-2.5 text-sm font-medium backdrop-blur-md">
                <Download className="w-4 h-4" />
                <span>Download Resume</span>
              </a>
            ) : (
              <button className="hidden md:flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 transition-colors rounded-full px-4 lg:px-6 py-2.5 text-sm font-medium backdrop-blur-md opacity-50 cursor-not-allowed" title="No resume available">
                <Download className="w-4 h-4" />
                <span>Download Resume</span>
              </button>
            )}
            <button
              ...
              className="md:hidden flex items-center justify-center p-2.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 backdrop-blur-md text-white/80 hover:text-white transition-colors"
